pipeline {
    ...
    environment {
        ...
        REPOSITORY_NAME  = 'curator-articlelinker'
    }
    ...
    stages {
        ...
        stage('Setup and build') {
            ...
            stages {
                ...
                stage('Build') {
                    steps {
                        sh label: 'Build binaries', script: 'bundle exec rake curator-articlelinker:build'
                    }
                }
                stage('Build artifact') {
                    steps {
                        sh label: 'Build artifact', script: "bundle exec rake curator-articlelinker:build_artifact ARTIFACT_VERSION=${env.ARTIFACT_VERSION}"
